                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="add_event.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Add Event</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="add_sponsor.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                                ...
                                                <div class="card-block">
                                                    <form class="form-material"
                                                        ...
                                                        <div class="form-group form-default form-static-label">
                                                            ...
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Description du
                                                                Sponsor</label>
                                                        </div>
