...
<body>
    ...
    ?>
            ...
            ?>
                                                            ...
                                                            <!-- Déboguer : afficher les sponsors -->
                                                    ...
                                                    <script>
                                                    // Fonction de validation de l'événement
                                                    function validateForm() {
                                                        let valid = true;

                                                        // Validation du titre : > 3 caractères
                                                        ...
                                                        // Validation de la date : supérieure à la date actuelle
                                                        const date = document.getElementById('date').value;
                                                        const dateError = document.getElementById('dateError');
                                                        const currentDate = new Date().toISOString().split('T')[
                                                            0]; // Date au format 'YYYY-MM-DD'
                                                        if (date <= currentDate) {
                                                        ...
                                                        // Validation du lieu : champ non vide
                                                        ...
                                                        // Validation de la description : champ non vide
                                                        ...
                                                        // Validation de l'image : doit être une image valide
                                                    ...
                                                    // Ajouter un événement "keyup" pour valider les champs à chaque modification
                                                    ...
                                                    // Valider lors du chargement initial du formulaire
                                        ...
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>Modifier Sponsor</h5>
                                                </div>
                                                <div class="card-block">
                                                    <form class="form-material"
                                                        action="../../controller/sponsorController.php" method="POST"
                                                        enctype="multipart/form-data">
                                                        <!-- Nom du Sponsor -->
                                                        <div class="form-group form-default form-static-label">
                                                            <input type="text" name="nom_sp" class="form-control"
                                                                placeholder="Nom du sponsor"
                                                                value="<?= isset($sponsor) ? htmlspecialchars($sponsor['nom_sp']) : '' ?>"
                                                                required />
                                                            <span class="form-bar"></span>
                                                        ...
                                                        <div class="form-group form-default form-static-label">
                                                            ...
                                                            <!-- Optionally display the existing logo -->
                                                            <?php if (isset($sponsor['logo'])): ?>
                                                            <div>
                                                                <img src="../../uploads/<?= htmlspecialchars($sponsor['logo']) ?>"
                                                        ...
                                                        <div class="form-group form-default form-static-label">
                                                            <input type="url" name="website" class="form-control"
                                                                placeholder="Website du sponsor"
                                                                value="<?= isset($sponsor) ? htmlspecialchars($sponsor['website']) : '' ?>"
                                                                required />
                                                            <span class="form-bar"></span>
                                                        ...
                                                        <div class="form-group form-default form-static-label">
                                                            <textarea name="description" class="form-control"
                                                                required><?= isset($sponsor) ? htmlspecialchars($sponsor['description']) : '' ?></textarea>
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Description du Sponsor</label>
                                                        </div>

                                                        <!-- Hidden Input for Sponsor ID -->
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit"
                                                                class="btn btn-primary"><?= isset($sponsor) ? 'Mettre à jour' : 'Ajouter le Sponsor' ?></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <form>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">RTL
                                                                Text</label>
                                                            <div class="col-sm-10">
