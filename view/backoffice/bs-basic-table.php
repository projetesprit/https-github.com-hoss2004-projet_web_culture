...
<body>
        ...
        ?>
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th><?= htmlspecialchars($event['id']); ?></th>
    ...
    if (!empty($event['image']) && file_exists($imagePath)): ?>
                                                                ...
                                                                <td><?= htmlspecialchars($event['id_sponsor'] ?? 'Non spécifié'); ?>
                                                                </td>
                                                                <td>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Tableau des Sponsors</h5>
                                                <span>Regular table background variants are not available with the
                                                    inverse table, however, you may use
                                                    <code>text or background utilities</code> to achieve similar
                                                    styles.</span>
                                                <div class="card-header-right">
                                                    <ul class="list-unstyled card-option">
                                                        <li><i class="fa fa fa-wrench open-card-option"></i></li>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <?php
        require_once '../../controller/sponsorController.php'; // Chemin vers le fichier contenant la fonction getAllSponsors
        $sponsors = getAllSponsors(); // Récupération de tous les sponsors depuis la base de données
        ?>
                                                    <table class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= htmlspecialchars($sponsor['nom_sp']); ?></td>
                                                                <td><?= htmlspecialchars($sponsor['description']); ?>
                                                                </td>
                                                                <td>
                                                                    <a href="<?= htmlspecialchars($sponsor['website']); ?>"
                                                                        target="_blank">
                                                                ...
                                                                <td>
                                                                    <?php
    // Construire le chemin de l'image du logo en utilisant le bon dossier
    $logoPath = "../../images/" . htmlspecialchars($sponsor['logo']);

    // Vérifier si l'image existe à ce chemin
    if (!empty($sponsor['logo']) && file_exists($logoPath)): ?>
                                                                ...
                                                                <td>
                                                                    <a href="edit_sponsor.php?id=<?= htmlspecialchars($sponsor['id_sponsor']); ?>"
                                                                        class="btn btn-warning">Modifier</a>
                                                                    <a href="../../controller/sponsorController.php?delete_sponsor=<?= htmlspecialchars($sponsor['id_sponsor']); ?>"
                                                                        class="btn btn-danger"
                                                            ...
                                                            <?php else: ?>
                                                            <tr>
                                                                <td colspan="6" class="text-center">Aucun sponsor
                                                                    trouvé.</td>
                                                            </tr>
                                                            <?php endif; ?>
                                                        </tbody>
